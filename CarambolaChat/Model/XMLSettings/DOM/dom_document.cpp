...
#include "dom_text.h"
#include "dom_comment.h"
#include "dom_cdata_section.h"
#include "dom_processing_instruction.h"
#include "dom_attr.h"
#include "dom_entity_reference.h"
...
{
	throw uicore::Exception("Implement me");
}
	...
	try
	{
		...
		while (cur_token.type != XMLToken::NULL_TOKEN)
		{
			...
			case XMLToken::ELEMENT_TOKEN:
				...
				{
					node_stack.pop_back();
					if (node_stack.empty()) throw uicore::Exception("Malformed XML tree!");
				}
				break;
