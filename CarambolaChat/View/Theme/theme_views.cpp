...
ThemeButtonView::ThemeButtonView()
{
	...
	style()->set("border-image-source:url('Theme/button_normal.png');");
	style("hot")->set("border-image-source:url('Theme/button_hot.png');");
	style("pressed")->set("border-image-source:url('Theme/button_pressed.png');");
...
ThemeCheckBoxView::ThemeCheckBoxView()
{
	...
	style()->set("background-image:url('Theme/checkbox_unchecked_normal.png');");
	style("unchecked_hot")->set("background-image:url('Theme/checkbox_unchecked_hot.png');");
	style("unchecked_pressed")->set("background-image:url('Theme/checkbox_unchecked_pressed.png');");
	style("unchecked_disabled")->set("background-image:url('Theme/checkbox_unchecked_disabled.png');");
	style("checked")->set("background-image:url('Theme/checkbox_checked_normal.png');");
	style("checked_hot")->set("background-image:url('Theme/checkbox_checked_hot.png');");
	style("checked_pressed")->set("background-image:url('Theme/checkbox_checked_pressed.png');");
...
ThemeRadioButtonView::ThemeRadioButtonView()
{
	...
	style()->set("background-attachment:scroll;");
	style()->set("width:13px; height:13px");
	style()->set("background-image:url('Theme/radio_unchecked_normal.png');");
	style("unchecked_hot")->set("background-image:url('Theme/radio_unchecked_hot.png');");
	style("unchecked_pressed")->set("background-image:url('Theme/radio_unchecked_pressed.png');");
	style("unchecked_disabled")->set("background-image:url('Theme/radio_unchecked_disabled.png');");
	style("checked")->set("background-image:url('Theme/radio_checked_normal.png');");
	style("checked_hot")->set("background-image:url('Theme/radio_checked_hot.png');");
	style("checked_pressed")->set("background-image:url('Theme/radio_checked_pressed.png');");
